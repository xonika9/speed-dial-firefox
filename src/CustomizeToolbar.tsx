...
import { ToolbarButtonIcon, ToolbarKind, toolbarKindDisplayString } from './Toolbar';
import {
    Sortable,
...
const CustomizeToolbar: Component<CustomizeToolbarProps> = props => {
    ...
    const [toolbar, setToolbar] = createSignal<ToolbarKindRef[]>(settings.toolbar.map(box));
    ...
    return (
        <CustomizeSortableContext.Provider value={createSortableContextValue<ToolbarKindRef>()}>
