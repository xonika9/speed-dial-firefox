import { BiRegularCircle, BiRegularPlus, BiSolidCheckCircle } from 'solid-icons/bi';
import {
    Component,
    Show,
    createEffect,
...
import { StorageDatabase, backgroundImageStore, dbSet, isUsingIdb } from './utils/database';
...
const SelectedButton: Component<SelectedButtonProps> = props => {
    ...
    return (
        <div
            ...
            onClick={onSelected}
            onKeyDown={applyFilter(enterKeyFilter)(onSelected)}
        >
...
const BackgroundPicker: Component = () => {
    ...
    const [strColorValue, setStrColorValue] = createSignal(settings.backgroundColor);
    ...
    onMount(() => {
        ...
        uploadBigButton.addEventListener('change', uploadChangeListener(uploadBigButton));
    });
        ...
        <div class='settings-background-container'>
            <div class='settings-background-item'>
                ...
                >
                    ...
                    >
                        <input type='file' accept='image/png, image/jpeg' ref={uploadButtonRef} />
            ...
            <Show when={storedBackgroundUrl()}>
                {nnPrevious => (
                    <div class='settings-background-item'>
                        ...
                        >
                            <SelectedButton selected={selected() == 'previous'} button={false} />
            ...
            <div class='settings-background-item'>
                ...
                <div
                    class={`${selected() == 'color' ? 'settings-background-selected' : ''}`}
                    style={{
                        'flex-grow': '1',
                        'border-radius': '10px',
                    }}
