...
const BookmarkTileContextMenu: Component<BookmarkTileContextMenuProps> = props => {
                ...
                >
                    ...
                    <Modal show={showDeleteModal()} onClose={() => setShowDeleteModal(false)}>
                        <div class='modal-content' style={{ 'max-width': '550px' }}>
                            Confirm you would like to delete the bookmark "{folderItem.item.title}"
                        </div>
                        <div class='modal-separator' />
                        <div class='modal-buttons'>
                            <button
            ...
            <ContextMenu event={onContext()}>
                <BookmarkTileContextMenu
                    onReloadImage={async () => {
                        ...
                        const image = await memoRetrieveAutoBookmarkImage(folderItem.item.url!);
                        setVisual(undefined);
                        if (image != null) {
                            setVisual({
