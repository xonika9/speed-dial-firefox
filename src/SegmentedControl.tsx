...
type ControlProps<T> = SegmentedControlPropsLocal<T> & JSX.HTMLAttributes<HTMLDivElement>;
...
export function createSegmented<T>() {
    ...
    return {
        Control: (props: ControlProps<T>) => {
            ...
            return (
                <Context.Provider value={{ choice: () => props.choice, onChoice: props.onChoice }}>
        ...
        Segment: (props: SegmentProps<T>) => {
            ...
            return (
                <div
                    ...
                    onKeyDown={applyFilter(enterKeyFilter)(() => context.onChoice?.(props.key))}
                >
                    {props.children}
                </div>
            );
